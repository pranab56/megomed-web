...
import { useMySubcriptionQuery, useSubcriptionReneiewMutation } from '../../features/subcription/subcriptionApi';
...
const SubscriptionPlanContent = dynamic(
  () =>
    Promise.resolve(({ userType, messages }) => {
      ...
      const [subcriptionRenew, { isLoading: renewLoading }] = useSubcriptionReneiewMutation();
      ...
      const isButtonDisabled = (plan) => {
        return (renewLoading && renewingSubscriptionId === plan.id) || plan.isRunning;
      };
      ...
      return (
        <div className="w-full bg-white py-4 md:py-6 max-w-7xl mx-auto px-4 md:px-6 2xl:px-0 ">
          <div className="container mx-auto px-4 max-w-7xl">
            {/* Error Message */}
            {errorMessage && (
              <div className={`mb-6 p-4 rounded-lg border ${errorMessage.includes('successfully')
            ...
            <div className="animate-fade-in-up">
              ...
              <div className="text-center mb-12">
                ...
                <h1 className="text-4xl font-bold text-gray-900 mb-4">
                  {subscriptionPlanTranslations.title || "Your Subscription Plans"}
                </h1>
                      ...
                      <div className="p-6 h-full flex flex-col">
                        ...
                        <div className="text-center mb-6">
                          ...
                          <div className="flex justify-center gap-2">
                            <Badge variant={
                              ...
                              {plan.isRunning ? 'Running' : plan.isExpired ? 'Expired' : plan.status}
                            </Badge>
                            {plan.isBadge && <Badge variant="outline">Badge</Badge>}
                            {plan.isSupport && <Badge variant="outline">Support</Badge>}
                          </div>
                        </div>
                        ...
                        <div className="mb-6 text-center">
                          ...
                          <p className="text-sm text-gray-600 mt-2">
                            Tenders: {plan.takeTenderCount || 0}/{plan.tenderCount}
                          </p>
                        </div>
                        ...
                        <div className="mb-6 space-y-2">
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="font-medium capitalize">{plan.category}</span>
                          </div>
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-600">End Date:</span>
                            <span className={`font-medium ${plan.isExpired ? 'text-red-600' : ''}`}>
                        ...
                        {plan.isExpired && (
                          <p className="text-xs text-red-600 mt-2 text-center">
                            Your subscription has expired. Click "Upgrade" to renew and continue.
                          </p>
                        )}
                        {plan.isRunning && (
